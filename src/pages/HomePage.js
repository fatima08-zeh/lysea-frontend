...
const HomePage = () => {
  ...
  return (
    <div className="home-page">
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <p className="subtitle">
            ...
            Femme de passion et visionnaire, Karine Joncas a créé une cosmétique unique, performante et innovante conçue et adaptée pour la femme active moderne.
            La science de l’EFFICACITÉ, de la BEAUTÉ et du BIEN-ÊTRE sont les forces motrices derrière la philosophie de la marque.
            Découvrez comment chacune d’entre elles se reflètent dans la gamme KARINE JONCAS.
            EFFICACITÉ : Des formules chargées en ingrédients haute performance éprouvés en clinique.
            BEAUTÉ : Une peau d’apparence plus jeune, mais également plus en santé.
            BIEN-ÊTRE : Une expérience sensorielle unique de bien-être globale.
          </p>
          <p className="secondary-text">
            Des produits fabriqués au Québec avec des ingrédients de qualité, testés par des dermatologues, pour une peau saine, lumineuse et respectée.
            Aux femmes qui veulent se sentir encore plus confiantes, fortes et belles, Watier est une pionnière dans l’industrie de la beauté, parce qu’elle crée des formules qui subliment votre beauté unique.
          </p>
          <button onClick={() => navigate("/beautypage")}>Voir les produits</button>
        </div>
      ...
      {/* Routine beauté microfluidique */}
      <section className="routine">
        <div className="routine-left">
          <h3>HYDRA BEAUTY</h3>
          <h2>LA ROUTINE BEAUTÉ MICROFLUIDIQUE</h2>
          <p>
            Trois coffrets composés d'essentiels beauté et conçus pour les moments que vous vivez :
            soirées audacieuses, soirées sereines et aventures lointaines.
          </p>
...
{/* Deep Cleansing Oil – Lise Watier */}
    ...
    >
      ...
      <section className="why-dangila">
        ...
        <p className="why-subtext">
          Des soins testés, sans effets secondaires, et entièrement naturels, conçus pour votre bien-être global.
        </p>
      ...
      <section className="about-lyséa">
        <div className="about-left">
          ...
          <p>
            ...
            Une peau nourrie, radieuse et respectée, dans une expérience sensorielle unique.
          </p>
          <div className="about-buttons">
            <button className="btn-buy" onClick={() => navigate("/beautypage")}>Acheter</button>
      ...
      <footer className="footer">
        <div className="footer-col">
          <p>Apprenez à aimer l’évolution et le changement<br />et vous réussirez.</p>
          <p>
